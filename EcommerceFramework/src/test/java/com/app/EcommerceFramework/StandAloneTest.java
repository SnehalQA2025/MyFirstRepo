package com.app.EcommerceFramework;
...
public class StandAloneTest {
	...
	driver.findElement(By.id("userEmail")).sendKeys("sonalsonar@gmail.com");
	driver.findElement(By.id("userPassword")).sendKeys("Sonal@sonar123");
	...
	WebElement prod = products.stream().filter(product -> 
	          ...
	          // using xpath(//button[contains(@class,'ta-item')])[2]
