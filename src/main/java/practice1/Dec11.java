...
public class Dec11 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("inputUsername")).sendKeys("Snehal");
		...
		driver.findElement(By.cssSelector("input[type='text']:nth-child(3)")).sendKeys("pqr@gmail.com");
		driver.findElement(By.xpath("//form/input[3]")).sendKeys("9865523555");
